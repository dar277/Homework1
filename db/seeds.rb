...
Review.delete_all
Review.create("title" => "Orphan Train", "stars" => "5", "review" => "Riveting!")
Review.create("title" => "Orphan Train", "stars" => "2", "review" => "About as dull as you can get.")
Review.create("title" => "Orphan Train", "stars" => "3", "review" => "Not bad.")
Review.create("title" => "Shadow Spell", "stars" => "4", "review" => "Great book, and not too many pages.")
Review.create("title" => "Shadow Spell", "stars" => "4", "review" => "Excellent font and margins. Story wasn't bad, either.")
Review.create("title" => "Shadow Spell", "stars" => "4", "review" => "Worth reading when there isn't a hockey game on.")
Review.create("title" => "Shadow Spell", "stars" => "1", "review" => "Didn't understand it at all.")
Review.create("title" => "The Alchemist", "stars" => "2", "review" => "I thought this was about how to make gold?")
Review.create("title" => "The Alchemist", "stars" => "4", "review" => "Suspensful plot, good characters.")
Review.create("title" => "The Alchemist", "stars" => "5", "review" => "Perfect. A work of art.")
Review.create("title" => "The Alchemist", "stars" => "3", "review" => "Kind of confusing.")
